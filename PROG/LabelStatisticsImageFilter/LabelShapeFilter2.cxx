...
main(int argc, char * argv[])
{
  ...
  //using ConnectedComponentImageFilterType = itk::ConnectedComponentImageFilter<InputImageType, OutputImageType2>;
  ...
  */
  ...
  i2l->SetInput(labelMapToLabelImageFilter->GetOutput());
...
writerB1->SetInput(labelMapToLabelImageFilter->GetOutput());
