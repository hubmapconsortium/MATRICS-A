...
main(int argc, char * argv[])
{
  ...
  std::string fileName, OutputFile, zSlice;
  ...
  for (unsigned int n = 0; n < labelMap->GetNumberOfLabelObjects(); ++n)
  {
    ...
    std::cout<<itk::NumericTraits<LabelMapType::LabelType>::PrintType(labelObject->GetLabel())<<","<<labelObject->GetCentroid()[0]<<","<<labelObject->GetCentroid()[1]<<","<<zSlice<<std::endl;
