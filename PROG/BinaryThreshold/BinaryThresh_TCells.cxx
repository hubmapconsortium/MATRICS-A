...
double lowerThreshold=1.8, upperThreshold=2;
double lowerThreshold2=0.8, upperThreshold2=1;
...
thresholdFilter2->SetInput(readerFL->GetOutput());
...
std::string NClass5 = inputFile+"_THlp.nii.gz";
writerB1->SetFileName(NClass5);
writerB1->Update();

ImageWriter::Pointer writerB2 =ImageWriter::New();
writerB2->SetInput(thresholdFilter2->GetOutput());
std::string NClass6 = inputFile+"_TReg.nii.gz";
writerB2->SetFileName(NClass6);
writerB2->Update();
