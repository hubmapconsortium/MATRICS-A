...
DATA=sys.argv[1]
imName = DATA + '/DAPI/S002_mono_dapi_reg_pyr16_region_%03d.tif'
tsSegName = '/DAPI/S002_mono_dapi_reg_pyr16_region_%03d.tif'

outImageFN = DATA + '/DAPI/NucleiSegmentation/dapi_Slide%d_region%d.tif'
nucSegFN = DATA + '/DAPI/NucleiSegmentation/dapi_Slide%d_region%d_nucseg.tif'
cytSegFN = DATA + '/DAPI/NucleiSegmentation/dapi_Slide%d_region%d_cytseg.tif'
