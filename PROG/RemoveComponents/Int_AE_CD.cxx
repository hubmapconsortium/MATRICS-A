...
int main(int argc, char *argv[] )
{
  if( argc < 3 )
    ...
    std::cerr << argv[0] << "  P53 AE1   outputImageFile" << std::endl;
    return EXIT_FAILURE;
    }
  ...
  filter->Update();
  */
  float lowerThreshold=1.5, upperThreshold=2.5;
  ...
  */
  ...
  thresholdFilter3->SetLowerThreshold(lowerThreshold);
  thresholdFilter3->SetUpperThreshold(upperThreshold);
