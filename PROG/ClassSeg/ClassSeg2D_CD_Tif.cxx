...
int main(int argc, char *argv[]) {
  ...
  std::string::size_type pos = inputFile.find(".tif");
...
//InputImageType::RegionType vecCL3Region;
//InputImageType::RegionType vecCL4Region;
/*InputImageType::RegionType vecCL5Region;
InputImageType::RegionType vecCL6Region;
/*InputImageType::RegionType vecCL7Region;
InputImageType::RegionType vecCL8Region;
InputImageType::RegionType vecCL9Region;
InputImageType::RegionType vecCL10Region;*/
...
std::string NClass1 = inputFile+"_BackGround_Prob.tif";
std::string NClass2 = inputFile+"_Prob.tif";
